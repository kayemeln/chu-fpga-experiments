...
(
	...
	logic [3:0] bcd1_reg, bcd0_reg;
	logic [3:0] bcd1_next, bcd0_next;
	logic [3:0] bcd1_temp, bcd0_temp;
	...
	begin
		...
		case (state_reg)
			...
			op: begin
				bcd1_next = {1'b0, bcd1_temp[3:1]};
				bcd0_next = {bcd1_temp[0], bcd0_temp[3:1]};

				bin_next = {bcd0_temp[0], bin_reg[6:1]};
				n_next = n_reg - 1;
				if (n_next == 1)
					state_next = done;
			end
